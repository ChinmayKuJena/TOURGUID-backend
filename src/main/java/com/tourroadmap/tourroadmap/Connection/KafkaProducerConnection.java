...
public class KafkaProducerConnection {
    private static final Logger log = LoggerFactory.getLogger(KafkaProducerConnection.class);
    ...
    private void sendMessage(String topicName, String message) {
        ...
        try {
            ...
            producer = null; // Mark producer as null to trigger reinitialization next time
        }
    }
